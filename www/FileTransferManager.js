...
var FileTransferUploadOperation = require('./FileTransferUploadOperation');
 ...
 */
FileTransferManager.prototype.createFileUpload = function(uploadSettings) {
    return new FileTransferUploadOperation(uploadSettings);
};
